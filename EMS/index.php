...
<div class="row">
	<div class="col-md-4 col-md-offset-3">
		...
		<center><h2 style="margin-top:1px;">Employee Management System</h2></center>
			<form class="form-horizontal form-custom-login" action="" method="POST">
			  ...
			  <button type="submit" name="login_btn" class="btn btn-info pull-right" id="logbtn">Login</button>
			</form>
		</div>
	</div>
</div>
